function [dense_1, state] = onnxLandmarkFcn(image_input, params, varargin)
%ONNXLANDMARKFCN Function implementing an imported ONNX network.
%
...
%
% [DENSE_1] = onnxLandmarkFcn(IMAGE_INPUT, PARAMS)
%			- Evaluates the imported ONNX network ONNXLANDMARKFCN with input(s)
%			IMAGE_INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in DENSE_1.
%
% [DENSE_1, STATE] = onnxLandmarkFcn(IMAGE_INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = onnxLandmarkFcn(IMAGE_INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to onnxLandmarkFcn:
p = inputParser;
